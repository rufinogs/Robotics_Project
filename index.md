...
<form method="post" action="https://rufinogs.github.io"><textarea name="comments" cols="110" rows="6" class="html-text-box">Comments here...</textarea><br><input type="submit" value="Submit" class="html-text-box"><input type="reset" value="Reset" class="html-text-box"></form>
<br> <br/>
